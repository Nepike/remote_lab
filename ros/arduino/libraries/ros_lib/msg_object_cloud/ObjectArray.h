#ifndef _ROS_msg_object_cloud_ObjectArray_h
#define _ROS_msg_object_cloud_ObjectArray_h

#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
#include "msg_object_cloud/Object.h"
...
namespace msg_object_cloud
{
  ...
  class ObjectArray : public ros::Msg
  {
    public:
      ...
      typedef msg_object_cloud::Object _objects_type;
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      if(objects_lengthT > objects_length)
        this->objects = (msg_object_cloud::Object*)realloc(this->objects, objects_lengthT * sizeof(msg_object_cloud::Object));
      objects_length = objects_lengthT;
      for( uint32_t i = 0; i < objects_length; i++){
      offset += this->st_objects.deserialize(inbuffer + offset);
        memcpy( &(this->objects[i]), &(this->st_objects), sizeof(msg_object_cloud::Object));
      }
     return offset;
    }

    virtual const char * getType() override { return "msg_object_cloud/ObjectArray"; };
    virtual const char * getMD5() override { return "fe62411687e5291b74b8d2293799db7c"; };

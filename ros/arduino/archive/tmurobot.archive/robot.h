 ...
 */
extern void MotorLeftGo(int pwmspeed);
extern void MotorRightGo(int pwmspeed);
...
void goFwd(int pwmspeed);
void goBack(int pwmspeed);
void goLeft(int pwmspeed);
void goFastLeft(int pwmspeed);
void goRight(int pwmspeed);
void goFastRight(int pwmspeed);
void robotStop(void);

...
/// Версия прошивки
#define IMVERSION 0x22
#define Title "MPCTL 1.22"
 ...
 * Геометрия робота
 */
#define RECnt  8    /// Количество импульсов энкодеров на 1 оборот колеса 
...
float minU = 0;
float maxU = 200; // 250     /// Крейсерская скорость
...
void setup()
{
  ...
  unsigned long tns = 1000000l * 2;    //  1 000'000 микросекунд (или 1 сек - или 1Hz)

 ...
 * \file mpwheelctl.ino
 * Progect:
 *  МПП. Управление рулевым колесом. Сервер
 *  Pololu MD03A VNH2SP30
 *  Chip ATmega328
 *  \author Robofob
 *  \version 1.06
 *  \date 05.05.2015
...
#define Title "MPWheelCtl 1.06"

// Управление двигателем. Только левое колесо
#define PIN_MOTOR_LPWM    5  // 1PWM (PWM)
#define PIN_MOTOR_LA      6  // 1INA
#define PIN_MOTOR_LB      7  // 1INB
...
void MotorGo(int pwmspeed) //Current
{
  if(pwmspeed==0)
  {

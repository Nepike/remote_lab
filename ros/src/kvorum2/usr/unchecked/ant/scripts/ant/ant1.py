...
def main(envfilename, mapfilename, agentfilename):
    ...
    global fsm_reflex, fsm_walk, fsm_bypassright, fsm_bypassleft, fsm_moveto, fsm_endofpath, fsm_back, fsm_aroundl, fsm_toleft, fsm_toright
    global JobREGIM
                ...
                if(sGetFL(a)<5 or sGetFR(a)<5):
                    ...
                    if(ObjX[0]>0):  # вижу ориентир нужного цвета по направлению ObjX[0]
                        ...
                        if(nextpoint>0): 
                            ...
                            if(JobREGIM==DEBUG): print "name1 = ", name1
                            FSM.reset()  # reset, если выбрали другой автомат
                        else: 
                            print "------------------------------ AroundL --------------------------------"
                            prevAuto = FSM 

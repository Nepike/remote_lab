...
def P(x,y,c): Env.SetRectangleField(x, y, x+10, y+20, gdic.LEVEL_COLOR, c)

def G(x,y):  Env.SetRectangleField(x, y, x+10, y+5, gdic.LEVEL_GROUND, 1)

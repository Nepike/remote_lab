...
DataPack::DataPack(HardwareSerial& serial) : args_types_(new ArgType[MAX_ARGS_COUNT]()), payload_(new uint8_t[MAX_PAYLOAD_SIZE]()), current_payload_index_(0), is_valid_(false) {
